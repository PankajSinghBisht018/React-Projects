...
function Home() {
  ...
  return (
    <div className="container mx-auto p-4">
      ...
      <div className="grid sm:grid-cols-2  md:grid-cols-4  lg:grid-cols-5 gap-4 mt-8 space-x-6 space-y-6">
        {cardImages.map((image, index) => (
          <motion.div key={index} className="border rounded-lg overflow-hidden shadow-lg "
